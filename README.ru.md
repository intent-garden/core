...
|-------------|------------|
| [`intent-garden/core`](.) | Clojure-движок валидации |
...
| Документ | Описание |
|----------|----------|
| [`CONTRACT.ru.md`](CONTRACT.ru.md) | Контракт для ИИ-агентов (правила тегирования) |
| [`specs/`](specs/) | Примеры EDN-контрактов |
| [`rulerom/registry`](https://github.com/rule-rom/registry) | Глобальная библиотека Intent-контрактов (Git Submodule) |

## 🔗 Связанные Проекты

- **RuleROM** — Система управления Intent-контрактами
- **rulerom/registry** — Глобальное зеркало стандартов и интентов
